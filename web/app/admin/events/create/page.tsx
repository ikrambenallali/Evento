                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <label
                        htmlFor="file-upload"
                        className="flex items-center justify-center w-full px-4 py-3 bg-amber-950/50 border border-orange-200/30 rounded-lg text-orange-100/60 hover:text-orange-100 hover:border-orange-200/60 cursor-pointer transition-all"
                      >
                        <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        </svg>
                        {fileName || 'Choisir une photo'}
                      </label>
                    </div>
                    {fileName && (
                      <p className="mt-2 text-sm text-orange-100/60 italic">
                  ...
                  <div className="flex gap-4 pt-4">
                    ...
                    <button
                      ...
                      className={`px-6 py-3 bg-amber-950/50 border border-orange-200/30 text-orange-100 rounded-lg hover:bg-amber-950/70 hover:border-orange-200/60 focus:outline-none focus:ring-2 focus:ring-orange-200/20 transition-all ${cinzel.className}`}
                      style={{ letterSpacing: '0.1em' }}
                    >
                      ANNULER
                    </button>
