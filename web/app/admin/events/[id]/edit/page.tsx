                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2">
                        <span className={`inline-block px-4 py-2 rounded-full text-sm ${cinzel.className} ${
                    ...
                    <div className="pt-4 border-t border-orange-200/20">
                      <button
                        type="submit"
                        className={`w-full px-6 py-3 bg-gradient-to-r from-orange-600 to-amber-600 text-white font-semibold rounded-lg hover:from-orange-500 hover:to-amber-500 focus:outline-none focus:ring-2 focus:ring-orange-200/50 transition-all shadow-lg hover:shadow-xl ${cinzel.className}`}
                        style={{ letterSpacing: '0.1em' }}
                      >
                    ...
                    <div className="pt-4 border-t border-orange-200/20">
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <button
                          ...
                          className={`px-4 py-2.5 bg-green-900/40 text-green-200 border border-green-200/30 rounded-lg hover:bg-green-900/60 transition-all text-sm ${cinzel.className}`}
                        ...
                        <button
                          ...
                          className={`px-4 py-2.5 bg-orange-900/40 text-orange-200 border border-orange-200/30 rounded-lg hover:bg-orange-900/60 transition-all text-sm ${cinzel.className}`}
                          style={{ letterSpacing: '0.05em' }}
                        >
                          ⊗ Annuler
                        </button>
                    ...
                    <div className="pt-4 border-t border-red-200/20">
                      <p className={`text-red-200/60 text-sm mb-3 ${cinzel.className}`} style={{ letterSpacing: '0.05em' }}>
                        ZONE DANGEREUSE
                      </p>
                      <button
                        type="button"
                        onClick={handleDelete}
                        className={`w-full px-4 py-2.5 bg-red-900/40 text-red-200 border border-red-200/30 rounded-lg hover:bg-red-900/60 transition-all text-sm ${cinzel.className}`}
                        style={{ letterSpacing: '0.05em' }}
                      >
